...
export default function Pricing() {
	...
	return (
		<div
			className="py-24 px-6 flex flex-col items-center justify-center bg-muted/30"
			id="pricing"
		>
			<Badge variant="outline" className="mb-4 text-muted-foreground">
				Component Preview
			</Badge>
			<h2 className="text-4xl md:text-5xl font-semibold text-center tracking-tight">
				{t("title")}
			</h2>
			...
			<div className="mt-12 container mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-3 gap-8">
				{plans.map((plan) => (
					<div
						key={plan.name}
						className={cn(
							"relative border border-border bg-background rounded-xl p-6 shadow-sm flex flex-col",
							{
